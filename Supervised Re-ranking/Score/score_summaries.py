...
sys.path.append("/content/drive/MyDrive/SummaReranker-main/src")
...
def main(args):
    ...
    # load summaries
    summaries_path = path + "summary_generated_val_m0304_50_100.pkl"
    #"summary_generated_without_mask.pkl"# "summary_generated_m0403.pkl" #"summary_generated_04.pkl#"summary_generated_06.pkl" #"summary_generated_05.pkl"  #"generated_summaries.pkl"
    with open(summaries_path, "rb") as f:
        summaries = pickle.load(f)
    print("Loaded {} summaries".format(len(summaries)))
    labels_path = path + "summary_input_val_without_mask_50_100.pkl" #"reference_summaries_cleaned.pkl"
    ...
    if "rouge" in args.label_metric:
        ...
        for j in range(args.num_candidates):
            all_summaries.append([])
        bart_scorer = BARTScorer(device=device, checkpoint='facebook/bart-base-cnn')
        scores = []
