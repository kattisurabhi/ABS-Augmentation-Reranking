...
def rouge_eval(mode, val_texts, val_summaries, val_labels, args):
    print("\n", "*"*10, "ROUGE evaluation with {}".format(mode), "*"*10)
    ...
    print(" R-1: {:.4f}, R-2: {:.4f}, R-L: {:.4f} ".format(
         mean_r1, mean_r2, mean_rl))
...
def new_ngram_eval(val_texts, val_summaries, args):
    print("\n", "*"*10, "Abstractiveness / New n-gram", "*"*10)
