...
# base model
parser.add_argument('--base_model_type', type=str, default="bart",
...
parser.add_argument('--inference_bs', type=int, default=16)
...
train_sizes = [[50, 50], [50, 50], [17000, 16704]]
val_sizes = [50, 11332, 4213]
test_sizes = [50, 11334, 4222]
...
def main(args):
    ...
    train_args = TrainingArguments(
        output_dir=args.save_model_path,  # change accordingly
